...
public:
	...
	void toggle(uint8_t state = true); //there is argument for use this method in true/false delegates, can use it without arguments too
	void invert(uint8_t state = true); //there is argument for use this method in true/false delegates, can use it without arguments too
