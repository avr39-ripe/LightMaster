...
void AppClass::init()
{
	char zoneNames[][27] = {{"Прихожая"},{"Терасса"},{"Холл споты"},{"Холл стол"},{"Холл центр"},{"Холл стена"},{"Холл окно"},{"Санузел"},{"Гостевая  1"},{"Гостевая 2"},{"Кухня"},{"Подвал"}, {"Бра 1"}, \
							{"Бра 2"},{"Стол комп"},{"Проход"},{"Угол"},{"Гардероб"},{"Спальня 1"},{"Спальня 2"},\
							{"Санузел 2"},{"Душевая"}, {"Ванна"}};
